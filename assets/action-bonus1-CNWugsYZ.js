import{r as h}from"./index-CVwNq2Ey.js";function v(n){return new Promise((t,a)=>{if(document.querySelector(`script[src="${n}"]`)){t();return}const r=document.createElement("script");r.src=n,r.onload=()=>t(),r.onerror=()=>a(new Error(`Script load error for ${n}`)),document.head.appendChild(r)})}function x(){return`
        <style>
